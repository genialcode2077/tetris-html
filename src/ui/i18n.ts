...
const es = {
  ...
  'modes.garbage': 'Basura cada',
  'modes.garbageOff': 'sin basura',
  'modes.garbagePieces': '{n} piezas',
  'modes.maxGravity': 'gravedad máxima',
  'modes.drill': 'Posición',
  'drill.none': 'Libre',
  'drill.tspinDouble': 'Giro doble de la T',
  'drill.tspinTriple': 'Giro triple de la T',
  'drill.perfectClear': 'Vaciar el tablero',
  'drill.immobileSpin': 'Giro por encaje',
  ...
  'replay.restart': 'Volver al principio',
  'replay.pause': 'Pausar',
  'replay.resume': 'Continuar',
  'replay.speed': 'Velocidad',
  'replay.exit': 'Salir',
  'replay.progress': 'Avance: {n} %',
...
const en: Record<MessageKey, string> = {
  ...
  'modes.garbage': 'Garbage every',
  'modes.garbageOff': 'no garbage',
  'modes.garbagePieces': '{n} pieces',
  'modes.maxGravity': 'max gravity',
  'modes.drill': 'Drill',
  'drill.none': 'Free play',
  'drill.tspinDouble': 'T-spin double',
  'drill.tspinTriple': 'T-spin triple',
  'drill.perfectClear': 'Perfect clear',
  'drill.immobileSpin': 'Immobile spin',
